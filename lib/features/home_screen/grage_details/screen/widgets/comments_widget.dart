                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            //                //   itemCount:cubit.grageModelDetails?.comments[index].replies.length,
                            ...
                            //                                         Expanded(
                            //                                           child: Text(
                            //                                              comment.replies[index].comment?? 'ايه عمرو',
                            //                                             // "hello",
                            //                                             maxLines: 1,
                            //                                             style: Styles.style16,
                            //                                           ),
                            //                                         ),
                            //                                         Text(
                            //                                          comment?.replies?[index].id.toString()??"",
                            //                                           overflow: TextOverflow.fade,
                            //                                         ),
                            //                                       ],
                            //                                     ),
                            ...
                            //                 child: TextField(
                            //                   controller: context
                            //                       .read<GrageDetailsCubit>().replyController,
                            ...
                            //                             .toString() ??
                            //                         "1",
                            //                     comment: cubit.replyController.text,
                            //                     isComment: false,
                            //                     comment_id:
                            //                         comment.id.toString(),
                            //                   );
                            ...
                            //     showModalBottomSheet(
                            //       context: context,
                            //       isScrollControlled: true, // This is important to make the bottom sheet adjustable
                            //       builder: (BuildContext context) {
                            //         return Container(
                            //           height: MediaQuery.of(context).size.width * 1.4,
                            //           padding: EdgeInsets.only(
                            ...
                            //             right: 16.0,
                            //             top: 16.0,
                            //             bottom: MediaQuery.of(context).viewInsets.bottom + 16.0, // Adjust padding to account for the keyboard
                            //           ),
                            //           child: Column(
                            //             mainAxisSize: MainAxisSize.min,
                            //             children: [
                            ...
                            //                                 child: ClipRRect(
                            //                                   child: Image.network(
                            //                                     EndPoints.baseUrlImage + (reply?.toString() ?? ''),
                            //                                     errorBuilder: (context, error, stackTrace) {
                            //                                       return Image.asset(
                            //                                         'assets/images/chair.jpg',
                            //                                         scale: 10,
                            ...
                            //                 padding: const EdgeInsets.all(3.0),
                            //                 child: TextField(
                            //                   controller: context.read<GrageDetailsCubit>().replyController,
                            //                   onSubmitted: (data) async {},
                            //                   decoration: InputDecoration(
                            //                     hintText: "SendMessage".tr(),
                            //                     filled: true,
                            ...
                            //                 onPressed: () {
                            //                   cubit.PostComments(
                            //                     auction_id: cubit.grageModelDetails?.id.toString() ?? "1",
                            //                     comment: cubit.replyController.text,
                            //                     isComment: false,
                            //                     comment_id: comment.id.toString(),
                            //                   );
                            //
                            //                   cubit.getGrageDetils(id: cubit.grageModelDetails?.id.toString()).then((e){
                            //                     cubit.replyController.clear();
                            //
                            //                   });
