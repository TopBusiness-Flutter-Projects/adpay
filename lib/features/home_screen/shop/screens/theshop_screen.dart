            ...
            children: [
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text("theShop".tr(), style: Styles.style20.copyWith(color: Colors.black)),
                ),
              ),
              CategoryCard(
...
class ShopsCatogrey extends StatelessWidget {
  const ShopsCatogrey({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemCount: statee.shopModel!.data!.length,
