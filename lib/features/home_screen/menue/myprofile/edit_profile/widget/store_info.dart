...
class StoreInfoWidget2 extends StatefulWidget {
  StoreInfoWidget2({required this.cubit, super.key});
  EditProfileCubit cubit;
  @override
  State<StoreInfoWidget2> createState() => _StoreInfoWidget2State();
}

class _StoreInfoWidget2State extends State<StoreInfoWidget2> {
  @override
