...
class UserInfoWidgetUser2 extends StatefulWidget {
  UserInfoWidgetUser2({required this.cubit,
    super.key});
  EditProfileCubit cubit;

  @override
  State<UserInfoWidgetUser2> createState() => _UserInfoWidgetUser2State();
}

class _UserInfoWidgetUser2State extends State<UserInfoWidgetUser2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Form(
          ...
          print("screen");
if(widget.cubit.passwprdController.text==widget.cubit.confirmPasswprdController.text){
