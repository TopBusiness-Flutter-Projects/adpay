                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                          cubit.profileModel?.data.name??"nehal",
                              maxLines: 1,
                              style: TextStyle(
                            ...
                            Text(cubit.profileModel?.data.phone.toString()??"0128686868"),
                          ],
                        ),
                      ),
                    ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("orders".tr()),
                              Text(
                                cubit.profileModel?.data.ordersCount.toString()??'0',
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Forester".tr()),
                              Text(
                                cubit.profileModel?.data.auctionsCount.toString()??"0",
                                style: Styles.style16.copyWith(color: Colors.black),
                              )
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                cubit.profileModel?.data.viewAdsCount.toString()??"0",
                                style: Styles.style16.copyWith(color: Colors.black),
                              )
                            ],
                          ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      cubit.profileModel?.data.points.toString()??"0",
                                      style: Styles.style16.copyWith(color: Colors.black),
                                    ),
                                  ],
                                )
