                          ...
                          children: [
                            Padding(
                              ...
                              child: ListTile(
                                ...
                                title: Text("menue".tr(),
                                    style: Styles.style20.copyWith(color: Colors
                                        .black)),
                              ),
                            ),
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text("Mydata".tr(), style: Styles
                                      .style16,),),
                              ),
                            ),
                            InkWell(
                                ...
                                child: MenueWidget(text: 'Profilepersonly'.tr(),
                            ...
                            InkWell(
                                ...
                                child: MenueWidget(text: 'Favorite'.tr(),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(7.0),
                                  child: Text("Settings".tr(), style: Styles
                                      .style16,),),
                              ),
                            ),
                            InkWell(
                                ...
                                child: MenueWidget(text: 'contactus'.tr(),
                                    path: 'assets/images/contactus.png')),
                            MenueWidget(text: 'aboutapp'.tr(),
                                path: 'assets/images/i.png'),
                            MenueWidget(text: 'Terms'.tr(),
                            ...
                            InkWell(
                              ...
                              child: MenueWidget(text: 'Shareapp'.tr(),
                            ...
                            InkWell(
                              ...
                              child: MenueWidget(text: 'evaluation'.tr(),
                            ...
                            InkWell(
                                ...
                                child: MenueWidget(text: 'Logout'.tr(),
                                    path: 'assets/images/logout.png')),
                          ]
                      )
                  )
