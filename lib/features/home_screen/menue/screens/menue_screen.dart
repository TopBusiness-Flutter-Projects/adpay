    ...
    return BlocBuilder<LogoutCubit, LogoutState>(builder: (context, state) {
      ...
      return SafeArea(
        ...
        InkWell(
            ...
            child: MenueWidget(
                text: 'Mymessages'.tr(), path: 'assets/images/message2.png')),
        InkWell(
            onTap: () {
        ...
        InkWell(
            ...
            child: MenueWidget(
                text: 'Favorite'.tr(), path: 'assets/images/favourite.png')),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Container(
            //  width: MediaQuery.sizeOf(context).width,
        ...
        InkWell(
            ...
            child: MenueWidget(
                text: 'contactus'.tr(), path: 'assets/images/contactus.png')),
        ...
        InkWell(
          ...
          child: MenueWidget(
              text: 'evaluation'.tr(), path: 'assets/images/evaluation.png'),
        ),
        // BlocProvider(
