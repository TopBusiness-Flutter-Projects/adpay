...
OrdersDetailsModel ordersDetailsModelFromJson(String str) => OrdersDetailsModel.fromJson(json.decode(str));

String ordersDetailsModelToJson(OrdersDetailsModel data) => json.encode(data.toJson());
...
class OrdersDetailsModel {
  ...
  factory OrdersDetailsModel.fromJson(Map<String, dynamic> json) => OrdersDetailsModel(
