...
class OrdersDetailsNewModel {
  ...
  factory OrdersDetailsNewModel.fromJson(Map<String, dynamic> json) =>
      OrdersDetailsNewModel(
        data: json["data"] == null
            ? null
            : NewOrderDetailsData.fromJson(json["data"]),
        msg: json["msg"],
        status: json["status"],
      );
...
class NewOrderDetailsData {
  ...
  factory NewOrderDetailsData.fromJson(Map<String, dynamic> json) =>
      NewOrderDetailsData(
        id: json["id"],
        type: json["type"],
